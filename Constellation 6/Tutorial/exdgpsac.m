...
% Since this simulation is prior to August 22, 1999, add a rollover flag of
% 0 to the GPS times
fh(1) = plotpass([t_vis_all zeros(size(t_vis_all,1),1)],num_dgps_all,ones(size(num_sats_all)),...
